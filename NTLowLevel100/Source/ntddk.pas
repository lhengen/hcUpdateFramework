...
initialization
  ...
  fnZwQuerySystemInformation := GetProcAddress (modNTDLL, 'NtQuerySystemInformation');
  ...
  fnZwOpenSection := GetProcAddress (modNTDLL, 'NtOpenSection');
  fnZwOpenFile := GetProcAddress (modNTDLL, 'NtOpenFile');
