...
function NetUserAdd (serverName : PWideChar; level : Integer; buffer : PChar; var parm_err : Integer) : NetAPIStatus; stdcall;
...
function NetUserSetInfo (serverName, userName : PWideChar; level : Integer; buffer : PChar; var parm_err : Integer) : NetAPIStatus; stdcall;
...
function NetUserSetGroups (serverName, userName : PWideChar; level : Integer; buffer : PChar; numEntries : Integer) : NetAPIStatus; stdcall;
...
function NetUserModalsSet (serverName : PWideChar; level : Integer; buffer : PChar; var parm_err : Integer) : NetAPIStatus; stdcall;
...
function NetGroupSetInfo (servername, groupName : PWideChar; level : Integer; buffer : PChar; var parm_err : Integer) : NetAPIStatus; stdcall;
...
function NetGroupSetUsers (serverName, groupName : PWideChar; level : Integer; buffer : Pchar; totalEntries : Integer) : NetAPIStatus; stdcall;
...
function NetLocalGroupSetInfo (serverName, groupName : PWideChar; level : Integer; buffer : Pchar; var parm_err : Integer) : NetAPIStatus; stdcall;
...
function NetLocalGroupSetMembers (serverName, groupName : PWideChar; level : Integer; buffer : PChar; totalEntries : Integer) : NetAPIStatus; stdcall;
function NetLocalGroupAddMembers (serverName, groupName : PWideChar; level : Integer; buffer : Pchar; totalEntries : Integer) : NetAPIStatus; stdcall;
function NetLocalGroupDelMembers (serverName, groupName : PWideChar; level : Integer; buffer : PChar; totalEntries : Integer) : NetAPIStatus; stdcall;
...
function NetAccessAdd (serverName : PWideChar; level : Integer; buffer : Pchar; var parm_err : Integer) : NetAPIStatus; stdcall;
...
function NetAccessSetInfo (serverName, resource : PWideChar; level : Integer; buffer : Pchar; var parm_err : Integer) : NetAPIStatus; stdcall;
...
function I_NetLogonControl2 (serverName : PWideChar; functionCode, queryLevel : Integer; data : PChar; var buffer : Pointer) : NetAPIStatus; stdcall;
