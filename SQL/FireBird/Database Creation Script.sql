...
(
  ...
  LOCATIONGUID GUID NOT NULL,
  CONSTRAINT PK_INSTALLATION PRIMARY KEY (LOCATIONGUID)
);
...
CREATE TABLE LOCATIONDEPLOYMENT
(
  LOCATIONGUID GUID NOT NULL,
  DEPLOYMENTGUID GUID NOT NULL,
  ...
  CONSTRAINT PK_LOCATIONDEPLOYMENT PRIMARY KEY (LOCATIONGUID,DEPLOYMENTGUID)
);
...
ALTER TABLE LOCATIONDEPLOYMENT ADD CONSTRAINT FK_LOCATION
  FOREIGN KEY (LOCATIONGUID) REFERENCES LOCATION (LOCATIONGUID);
ALTER TABLE LOCATIONDEPLOYMENT ADD CONSTRAINT CK_LOCDEPLOYMENTRESULT
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON LOCATIONDEPLOYMENT TO  SYSDBA WITH GRANT OPTION;
